wild_magic_list = [
	...
	"The caster becomes boneless for 1 minute",
	"A random creature rapidly ages until death then rencarnates",
	"a horrible cloud of awful smelling gast within a 50 foot area comes from the caster",
	"the caster becomes a floppy goldfish for 10 mins",
	"a random creature gets teleported rancomly within a mile",
	"Every spell cast in the next 30 seconds causes a wild surge",
	"Hair turns to spagitti, but it is delicious and heals, grows back in 24 horus",
	...
	"Your targets fingernails really itchy (dex save to not drop wepon)",
	"A random creature starts to uncontrolably sneeze glitter for the next hour"
]