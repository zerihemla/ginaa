...
class Ui_Ginaa_GUI(object):
    def setupUi(self, Ginaa_GUI):
        ...
        self.bad_item_button = QtWidgets.QPushButton(self.frame)
        self.bad_item_button.setObjectName("bad_item_button")
        self.gridLayout_3.addWidget(self.bad_item_button, 3, 1, 1, 1)
        self.random_item_button = QtWidgets.QPushButton(self.frame)
        self.random_item_button.setObjectName("random_item_button")
        self.gridLayout_3.addWidget(self.random_item_button, 2, 0, 2, 1)
        ...
        self.gridLayout_3.addWidget(self.random_corrupted_item_button, 7, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.random_magic_item_button, 6, 0, 1, 1)
        self.useless_item_button = QtWidgets.QPushButton(self.frame)
        self.useless_item_button.setObjectName("useless_item_button")
        self.gridLayout_3.addWidget(self.useless_item_button, 6, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.treasure_labsl, 0, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.line_9, 3, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.wonderous_box, 2, 1, 1, 1)
        self.gear_box = QtWidgets.QCheckBox(self.frame_8)
        self.gear_box.setObjectName("gear_box")
        self.gridLayout_7.addWidget(self.gear_box, 3, 0, 1, 1)
        self.quest_hook_box = QtWidgets.QCheckBox(self.frame_8)
        self.quest_hook_box.setObjectName("quest_hook_box")
        self.gridLayout_7.addWidget(self.quest_hook_box, 3, 1, 1, 1)
        ...
        self.gridLayout_8.addLayout(self.horizontalLayout_2, 7, 0, 1, 1)
        ...
        self.gridLayout_14 = QtWidgets.QGridLayout(self.dungon_tab)
        ...
        self.frame_5 = QtWidgets.QFrame(self.dungon_tab)
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_5.setObjectName("frame_5")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.frame_5)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.random_occurance_button = QtWidgets.QPushButton(self.frame_5)
        self.random_occurance_button.setObjectName("random_occurance_button")
        self.gridLayout_10.addWidget(self.random_occurance_button, 3, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.line_5, 1, 0, 1, 1)
        self.creepy_occurance_button = QtWidgets.QPushButton(self.frame_5)
        self.creepy_occurance_button.setObjectName("creepy_occurance_button")
        self.gridLayout_10.addWidget(self.creepy_occurance_button, 2, 0, 1, 1)
        self.combat_spices_button = QtWidgets.QPushButton(self.frame_5)
        self.combat_spices_button.setObjectName("combat_spices_button")
        self.gridLayout_10.addWidget(self.combat_spices_button, 4, 0, 1, 1)
        self.gridLayout_14.addWidget(self.frame_5, 1, 0, 1, 1)
        spacerItem2 = QtWidgets.QSpacerItem(20, 352, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_14.addItem(spacerItem2, 2, 0, 1, 1)
        self.tabWidget.addTab(self.dungon_tab, "")
        self.book_tab = QtWidgets.QWidget()
        self.book_tab.setObjectName("book_tab")
        self.gridLayout_11 = QtWidgets.QGridLayout(self.book_tab)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.scrollArea = QtWidgets.QScrollArea(self.book_tab)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 171, 218))
        ...
        self.gridLayout_12.addWidget(self.line_4, 1, 0, 1, 1)
        self.funny_books_box = QtWidgets.QCheckBox(self.frame_4)
        self.funny_books_box.setChecked(True)
        self.funny_books_box.setObjectName("funny_books_box")
        self.gridLayout_12.addWidget(self.funny_books_box, 2, 0, 1, 1)
        self.general_books_box = QtWidgets.QCheckBox(self.frame_4)
        self.general_books_box.setChecked(True)
        self.general_books_box.setObjectName("general_books_box")
        self.gridLayout_12.addWidget(self.general_books_box, 3, 0, 1, 1)
        self.evil_books_box = QtWidgets.QCheckBox(self.frame_4)
        self.evil_books_box.setChecked(True)
        self.evil_books_box.setObjectName("evil_books_box")
        self.gridLayout_12.addWidget(self.evil_books_box, 4, 0, 1, 1)
        self.evil_wizard_books_box = QtWidgets.QCheckBox(self.frame_4)
        self.evil_wizard_books_box.setChecked(True)
        self.evil_wizard_books_box.setObjectName("evil_wizard_books_box")
        self.gridLayout_12.addWidget(self.evil_wizard_books_box, 5, 0, 1, 1)
        self.generate_book_button = QtWidgets.QPushButton(self.frame_4)
        self.generate_book_button.setObjectName("generate_book_button")
        self.gridLayout_12.addWidget(self.generate_book_button, 6, 0, 1, 1)
        self.gridLayout_13.addWidget(self.frame_4, 0, 0, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(20, 390, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_13.addItem(spacerItem3, 1, 0, 1, 1)
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.gridLayout_11.addWidget(self.scrollArea, 0, 0, 1, 1)
        self.tabWidget.addTab(self.book_tab, "")
    ...
    def retranslateUi(self, Ginaa_GUI):
        ...
        self.bad_item_button.setText(_translate("Ginaa_GUI", "Bad Item"))
        ...
        self.useless_item_button.setText(_translate("Ginaa_GUI", "Useless Item"))
        ...
        self.gear_box.setText(_translate("Ginaa_GUI", "Gear"))
        self.quest_hook_box.setText(_translate("Ginaa_GUI", "Quest Hook"))
        ...
        self.random_occurance_button.setText(_translate("Ginaa_GUI", "Random"))
        self.label_5.setText(_translate("Ginaa_GUI", "Occurances"))
        self.creepy_occurance_button.setText(_translate("Ginaa_GUI", "Creepy"))
        self.combat_spices_button.setText(_translate("Ginaa_GUI", "Combat Spices"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.dungon_tab), _translate("Ginaa_GUI", "Dungon"))
        self.label_4.setText(_translate("Ginaa_GUI", "Books"))
        self.funny_books_box.setText(_translate("Ginaa_GUI", "Funny Books"))
        self.general_books_box.setText(_translate("Ginaa_GUI", "General Books"))
        self.evil_books_box.setText(_translate("Ginaa_GUI", "Evil Books"))
        self.evil_wizard_books_box.setText(_translate("Ginaa_GUI", "Evil Wizard Books"))
        self.generate_book_button.setText(_translate("Ginaa_GUI", "Generate Book"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.book_tab), _translate("Ginaa_GUI", "Books"))
