...
class Ui_Ginaa_GUI(object):
    def setupUi(self, Ginaa_GUI):
        ...
        self.random_book_button = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        self.random_book_button.setObjectName("random_book_button")
        self.gridLayout_12.addWidget(self.random_book_button, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Ginaa_GUI):
        ...
        self.random_book_button.setText(_translate("Ginaa_GUI", "Random Book"))
